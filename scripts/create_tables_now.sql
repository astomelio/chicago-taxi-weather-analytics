...
-- Script para crear tablas silver y gold
-- Ejecuta esto en BigQuery Console o usando bq command

-- 1. Crear taxi_trips_silver
...
-- 2. Crear daily_summary (ejecutar después de que taxi_trips_silver esté lista)
